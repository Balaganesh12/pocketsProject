...
import { FaGlobe, FaHouseUser, FaLock, FaQuestion, FaSignOutAlt, FaRegListAlt } from 'react-icons/fa'
...
const data: MenuItemProps[] = [
  { icon: <FaHouseUser size={16} />, color: 'blue', label: 'Project', link: '/project' },
]
...
export default function NavBar() {
  ...
  return (
    <Navbar width={{ sm: 300, lg: 400, base: 100,position:"fixed" }}>
